            ...
            <div className='w-full text-left space-y-3 pt-2'>
                ...
                <div className='grid grid-cols-2 gap-3'>
                    <Card 
                        ...
                        className={cn(
                            "p-4 text-center cursor-pointer transition-all duration-200 border-2 bg-card",
                            selectedRole === 'abonne' ? 'border-primary' : 'border-border/50 hover:border-border'
                        )}
                    >
                        <CardContent className="p-0 relative">
                             {selectedRole === 'abonne' && <CheckCircle className="h-5 w-5 text-primary absolute -top-2 -right-2 bg-card rounded-full" />}
                    ...
                    <Card 
                         ...
                         className={cn(
                            "p-4 text-center cursor-pointer transition-all duration-200 border-2 bg-card",
                             selectedRole === 'createur' ? 'border-primary' : 'border-border/50 hover:border-border'
                        )}
                    >
                         <CardContent className="p-0 relative">
                            {selectedRole === 'createur' && <CheckCircle className="h-5 w-5 text-primary absolute -top-2 -right-2 bg-card rounded-full" />}
                             <div className='mx-auto h-12 w-12 rounded-full bg-secondary flex items-center justify-center mb-2'>
